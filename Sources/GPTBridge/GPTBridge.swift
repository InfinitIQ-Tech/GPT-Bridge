...
public class GPTBridge {
    ...
    public static func generateImage(prompt: String, quality: ImageQuality = .high, size: ImageSize = .auto, background: ImageBackground = .auto, model: ImageModel = .gptImage) async throws -> ImageGenerationHandler {
